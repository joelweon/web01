 ...
 *   - 한마디로 웹 서버가 웹 브라우저에게 잠시 맡기는 데이터다.
 *   - 웹 브라우저는 웹 서버에 요청할 때 마다 
 *     요청 헤더에 웹 서버가 맡긴 데이터를 첨부해서 보낸다.
 *   - 예) 쿠폰
 *   
 * => HTTP 프로토콜 분석 : 웹 서버에서 웹브라우저로 쿠키 보내기
HTTP/1.1 200 OK
...
Content-Length: 11
Date: Fri, 23 Dec 2016 02:11:54 GMT
 * 
 * 
 * */
